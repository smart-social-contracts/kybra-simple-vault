...
def set_account_mock_transaction(
    ...
    """
    from vault.entities import VaultTransaction, Balance, test_mode_data
    ...
    try:
        ...
        logger.info(f"Creating mock transaction {tx_id}: {kind} from {principal_from} to {principal_to}, amount: {amount}")
