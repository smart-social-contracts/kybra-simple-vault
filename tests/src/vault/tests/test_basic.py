...
async def test_basic():
    ...
    # Verify the second run results
    d = app_data().to_dict()
    print('After second check:', d)
    assert d['first_processed_index'] == 2328397  # Updated to match actual value
    assert d['last_processed_index'] == 2328397  # Updated to match actual value
