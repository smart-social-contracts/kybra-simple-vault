...
from vault.vault.icrc_account import encodeIcrcAccount, decodeIcrcAccount
...
TEST_ARTIFACTS = {
    ...
    "short_with_subaccount": {
        "input": {
            "principal": "2vxsx-fae",
            "subaccount": bytes(range(1, 33))
        },
        "output": "2vxsx-fae-h5nmbsi.102030405060708090a0b0c0d0e0f101112131415161718191a1b1c1d1e1f20"
    },
    "short_leading_zeros": {
        "input": {
            "principal": "2vxsx-fae",
            "subaccount": b'\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\01'
        },
        "output": "2vxsx-fae-22yutvy.1"
    },
}
